  ...
  <body>
              ...
              <div class="media-list">
                ...
                <a href="#" class="media-list-link">
                  <div class="media pd-x-20 pd-y-15">
                    <img src="../../public/img/img3.jpg" class="wd-40 rounded-circle" alt="">
                ...
                <a href="#" class="media-list-link read">
                  <div class="media pd-x-20 pd-y-15">
                    <img src="../../public/img/img4.jpg" class="wd-40 rounded-circle" alt="">
                    <div class="media-body">
                      <div class="d-flex align-items-center justify-content-between mg-b-5">
                ...
                <a href="#" class="media-list-link read">
                  <div class="media pd-x-20 pd-y-15">
                    <img src="../../public/img/img7.jpg" class="wd-40 rounded-circle" alt="">
                    <div class="media-body">
                      <div class="d-flex align-items-center justify-content-between mg-b-5">
                ...
                <a href="#" class="media-list-link read">
                  <div class="media pd-x-20 pd-y-15">
                    <img src="../../public/img/img5.jpg" class="wd-40 rounded-circle" alt="">
                    <div class="media-body">
                      <div class="d-flex align-items-center justify-content-between mg-b-5">
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-header wd-300 pd-0-force">
              ...
              <div class="media-list">
                ...
                <a href="#" class="media-list-link read">
                  <div class="media pd-x-20 pd-y-15">
                    <img src="../../public/img/img8.jpg" class="wd-40 rounded-circle" alt="">
                    <div class="media-body">
                ...
                <a href="#" class="media-list-link read">
                  <div class="media pd-x-20 pd-y-15">
                    <img src="../../public/img/img9.jpg" class="wd-40 rounded-circle" alt="">
                    <div class="media-body">
                ...
                <a href="#" class="media-list-link read">
                  <div class="media pd-x-20 pd-y-15">
                    <img src="../../public/img/img10.jpg" class="wd-40 rounded-circle" alt="">
                    <div class="media-body">
        ...
        <div class="tab-pane pos-absolute a-0 mg-t-60 overflow-y-auto active" id="contacts" role="tabpanel">
          ...
          <div class="contact-list pd-x-10">
            <a href="#" class="contact-list-link new">
              <div class="d-flex">
                <div class="pos-relative">
                  <img src="../../public/img/img2.jpg" class="wd-40 rounded-circle" alt="">
            ...
            <a href="#" class="contact-list-link">
              <div class="d-flex">
                <div class="pos-relative">
                  <img src="../../public/img/img6.jpg" class="wd-40 rounded-circle" alt="">
                  <div class="contact-status-indicator bg-success bd-br-primary"></div>
                </div>
                <div class="contact-person">
    ...
    <div class="br-mainpanel">
      ...
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        ...
        <p class="mg-b-0">Desde esta ventana podras dar mantenimiento a productos</p>
      </div>
